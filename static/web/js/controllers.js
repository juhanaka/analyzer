...
analyzerApp.controller('DatasetCtrl', function($scope, $resource, $http) {
  var Dataset = $resource('/api/v0/datasets/:dataset_id', {dataset_id:'@dataset_id'})
  var Variable = $resource('/api/v0/datasets/:dataset_id/variables/:variable_id',
  ...
  $scope.calculateRegression = function() {
    ...
    var url = '/analysis/linear-regression/';
  ...
  $scope.calculateTTest = function() {
    ...
    var url = '/analysis/one-sample-ttest/';
